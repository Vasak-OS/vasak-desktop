...
<template>
  <div class="flex flex-col items-center gap-1 p-2 rounded-corner bg-ui-surface/80 group transition-all duration-200 ease-out hover:-translate-y-1 hover:scale-[1.02] border border-secondary w-28">
