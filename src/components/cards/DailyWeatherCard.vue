...
<template>
  <div class="flex flex-col items-center gap-1 p-2 rounded-corner bg-primary/80 group transition-all duration-200 ease-out hover:-translate-y-1 hover:scale-[1.02] hover:shadow-[0_3px_10px_rgba(0,0,0,0.15)]">
